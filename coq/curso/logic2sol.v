...
Proof.
  (* SOLUTION *)
  intros A B C H.
  inversion H. inversion H1.   (* could also use destruct *)
  split.
    Case "left". split.
      SCase "left". apply H0. 
      SCase "right". apply H2.
    Case "right". apply H3.
Qed.
...
Proof.
  ...
  (* SOLUTION *)
  unfold evenE. intros n. induction n.
  Case "O". simpl.  split.
    SCase "left conjunct". intros eq. apply even_0.
    SCase "right conjunct". intros eq. inversion eq.
  Case "S". split.
    SCase "left conjunct". intros eq. inversion IHn. 
      apply H0. apply eq.
    SCase "right conjunct". intros eq. inversion IHn. 
      apply even_SS. simpl in eq. apply H. apply eq.
Qed.
...
Proof.
  ...
  inversion G.
  split.
    Case "->". intros HA. apply H2. apply H0. apply HA.
    Case "<-". intros HC. apply H1. apply H3. apply HC.
Qed.
...
Proof.
  (* SOLUTION *)
  intros A B C. intros H. inversion H. inversion H0.
    Case "or_introl". left. apply H2.
    Case "or_intro2". inversion H1.
      SCase "or_introl". left. apply H3.
      SCase "or_intro2". right. 
                         split.
                           apply H2. 
                           apply H3.
Qed.
...
Proof.
  (* SOLUTION *)
  unfold not.
  intros A B H HNotB HA.
  apply HNotB.  apply H. apply HA.
Qed.
...
Proof.
  (* SOLUTION *)
  intros A H. inversion H. apply H1. apply H0.
Qed.
...
Proof.
  ...
  (* SOLUTION *)
    Case "even_0". intros H. inversion H.
    Case "even_SS". intros G. inversion G. apply IHevenI. apply H1.
Qed.
...
Proof.
  ...
  intros m. induction m.
    Case "O". 
      ...
      SCase "S". intros H. unfold not. intros contra. inversion contra. 
    Case "S". 
      intros n. destruct n.
      SCase "O". intros H. unfold not. intros contra. inversion contra.
      SCase "S". intros H. unfold not. (* not really needed *)
        intros eq.  inversion eq.
        unfold not in IHm. apply IHm with n. 
          simpl in H. apply H. 
          apply H1.
Qed.
...
Proof.
  (* SOLUTION *)
  intros X P Q. split.
    Case "->". intros H. inversion H. inversion H0. 
      SCase "l". left. exists witness. apply H1.
      SCase "r". right. exists witness. apply H1.
    Case "<-". intros H. inversion H. 
      SCase "l". inversion H0. exists witness. 
        left. apply H1.
      SCase "r". inversion H0. exists witness. 
        right. apply H1.
Qed.
...
Proof.
  (* SOLUTION *)
  intros X P H G. inversion G. unfold not in H0. apply H0. apply H.
Qed.
